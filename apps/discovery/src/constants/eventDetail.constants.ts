...
export const styles = {
  ...
  backBtn: cn(
    'absolute top-[100px] left-[5%] z-[100] flex items-center gap-2 bg-white py-2.5 px-5 rounded-full',
...
export const acts = [
  ...
  },
  {
    name: 'Global Talent',
    role: 'Co-Host',
    img: 'https://images.unsplash.com/photo-1493225457124-a1a2b163d76e?w=600',
    span: 1,
  },
];
